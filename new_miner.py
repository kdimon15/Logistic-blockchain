...
def transaction():
    if request.method == 'POST':
        ...
        if new_txion['from'] not in addr_items_dic or new_txion['from'] not in addr_places_dic or new_txion['item_id'] not in addr_items_dic[new_txion['from']] or new_txion['place_id'] not in addr_places_dic[new_txion['from']]:
